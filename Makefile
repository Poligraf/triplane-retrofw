PREFIX = /usr/local
DESTDIR = "/home/retrofw"

CXX	     = mipsel-linux-g++
OPTIFLAG     = -O3 -g
CFLAGS      := -Wall -Isrc $(OPTIFLAG) $(CFLAGS_NOSDL) `sdl-config --cflags` -DFAKE_MOUSE -DHAVE_SDL_MIXER "-DTRIPLANE_DATA=\"$(PREFIX)/share/games/triplane-classic\""
LDFLAGS      =
