...
void convert_dos_roster(struct dos_roster *droster) {
    ...
    for (l = 0; l < MAX_PLAYERS_IN_ROSTER; l++) {
        ...
        roster[l].up = SDLK_UP;
        roster[l].down = SDLK_DOWN;
        roster[l].roll = SDLK_LALT;
        roster[l].power = SDLK_LCTRL;
        roster[l].guns = SDLK_TAB;
        roster[l].bombs = SDLK_BACKSPACE;
    }
}
...
void load_keyset(void) {
    ...
    if ((faili = settings_open("keyset.dta", "rb")) == NULL) {
        ...
        player_keys[0].up = SDLK_UP;
        player_keys[0].down = SDLK_DOWN;
        player_keys[0].roll = SDLK_LALT;
        player_keys[0].power = SDLK_LCTRL;
        player_keys[0].guns = SDLK_TAB;
        player_keys[0].bombs = SDLK_BACKSPACE;
