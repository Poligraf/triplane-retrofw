	...
	fake_mouse();
        ...
        if ((n1 || n2) && menuselect) {
            ...
            case 1:
                ...
                roster[number].up =  SDLK_UP;
                roster[number].down = SDLK_DOWN;
                roster[number].roll = SDLK_LALT;
                roster[number].power = SDLK_LCTRL;
                roster[number].guns = SDLK_TAB;
                roster[number].bombs = SDLK_BACKSPACE;
